    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElasticStores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ElasticStores_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OtpStores_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TokenStores_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceDropAlertSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductSlug = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElasticStores_Category_IsActive",
                table: "ElasticStores",
                columns: new[] { "Category", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_ElasticStores_IsActive",
                table: "ElasticStores",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ElasticStores_ProductId",
                table: "ElasticStores",
                column: "ProductId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_TrackingStatus_PaymentStatus",
                table: "Orders",
                columns: new[] { "TrackingStatus", "PaymentStatus" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpStores_ExpiresAt",
                table: "OtpStores",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_OtpStores_Identifier_Purpose_IsUsed",
                table: "OtpStores",
                columns: new[] { "Identifier", "Purpose", "IsUsed" });

            migrationBuilder.CreateIndex(
                name: "IX_OtpStores_UserId",
                table: "OtpStores",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RateLimitLogs_BlockedUntil",
                table: "RateLimitLogs",
                column: "BlockedUntil");

            migrationBuilder.CreateIndex(
                name: "IX_RateLimitLogs_Identifier_Action",
                table: "RateLimitLogs",
                columns: new[] { "Identifier", "Action" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StockReservations_ExpiresAt_IsReleased",
                table: "StockReservations",
                columns: new[] { "ExpiresAt", "IsReleased" });

            migrationBuilder.CreateIndex(
                name: "IX_StockReservations_ProductId_IsReleased",
                table: "StockReservations",
                columns: new[] { "ProductId", "IsReleased" });

            migrationBuilder.CreateIndex(
                name: "IX_StockReservations_StripeSessionId",
                table: "StockReservations",
                column: "StripeSessionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TokenStores_ExpiresAt",
                table: "TokenStores",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_TokenStores_UserId_IsRevoked",
                table: "TokenStores",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_ProductId_PriceDropAlertSentAt",
                table: "Wishlists",
                columns: new[] { "ProductId", "PriceDropAlertSentAt" });
